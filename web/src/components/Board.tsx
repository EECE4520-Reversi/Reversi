  ...
  gameData: object
    ...
    return (
        ...
        <div className="flex items-center justify-center">
          <div className={`grid grid-cols-${size} grid-rows-${size} bg-green-700`}>
            {
              board && board.map((e, i) => <GamePiece key={i} idx={i} state={e} gameState={gameState} boardId={boardId} updateBoard={updateBoard}/>)
            }
          </div>
        </div>
      </div>
